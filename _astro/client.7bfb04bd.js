import {r as Ue} from "./index.ed373d49.js";
var No = {
    exports: {}
}
  , ve = {}
...
var Be = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , ku = {};
function Fa(e) {
    return Fl.call(ku, e) ? !0 : Fl.call(wu, e) ? !1 : Oa.test(e) ? ku[e] = !0 : (wu[e] = !0,
    !1)
}
function Ia(e, n, t, r) {
    if (t !== null && t.type === 0)
...
function ja(e, n, t, r) {
    if (n === null || typeof n > "u" || Ia(e, n, t, r))
        return !0;
    if (r)
        return !1;
    if (t !== null)
...
function Ti(e, n, t, r) {
    ...
    (l !== null ? l.type !== 0 : r || !(2 < n.length) || n[0] !== "o" && n[0] !== "O" || n[1] !== "n" && n[1] !== "N") && (ja(n, t, l, r) && (t = null),
    r || l === null ? Fa(n) && (t === null ? e.removeAttribute(n) : e.setAttribute(n, "" + t)) : l.mustUseProperty ? e[l.propertyName] = t === null ? l.type === 3 ? !1 : "" : t : (n = l.attributeName,
...
function $l(e, n) {
    if (n) {
        if (Ba[e] && (n.children != null || n.dangerouslySetInnerHTML != null))
            throw Error(y(137, e));
        if (n.dangerouslySetInnerHTML != null) {
            if (n.children != null)
                throw Error(y(60));
...
var ns, Ii, ts, rs, ls, ql = !1, nr = [], en = null, nn = null, tn = null, Lt = new Map, Mt = new Map, Ze = [], ic = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Tu(e, n) {
    switch (e) {
    case "focusin":
    case "focusout":
...
var Cc = A({}, $t, {
    key: function(e) {
        ...
        e === 13 ? "Enter" : String.fromCharCode(e)) : e.type === "keydown" || e.type === "keyup" ? kc[e.keyCode] || "Unidentified" : ""
    },
    code: 0,
    location: 0,
    ctrlKey: 0,
...
var Rc = Be && "TextEvent"in window && !kt
  , ss = Be && (!Hi || kt && 8 < kt && 11 >= kt)
...
function Fc(e, n) {
    if (Rn)
        return e === "compositionend" || !Hi && as(e, n) ? (e = os(),
        pr = Ui = qe = null,
        Rn = !1,
        e) : null;
    switch (e) {
...
var Le = typeof Object.is == "function" ? Object.is : Wc;
function Ot(e, n) {
    if (Le(e, n))
        return !0;
...
var Fn = {
  ...
  , kl = {}
  , hs = {};
Be && (hs = document.createElement("div").style,
...
fn(ys, "onAnimationEnd");
fn(gs, "onAnimationIteration");
fn(ws, "onAnimationStart");
fn("dblclick", "onDoubleClick");
fn("focusin", "onFocus");
fn("focusout", "onBlur");
fn(ks, "onTransitionEnd");
...
var yt = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
  , Xc = new Set("cancel close invalid load scroll toggle".split(" ").concat(yt));
function Qu(e, n, t) {
...
function Ft(e) {
    if (!e[lr]) {
        ...
        Lo.forEach(function(t) {
            t !== "selectionchange" && (Xc.has(t) || Cl(t, !1, e),
            Cl(t, !0, e))
        });
        ...
        if (!(n & 7)) {
            e: {
                ...
                g !== w)) {
                    ...
                    p.relatedTarget = d,
                    h = null,
                    gn(v) === f && (k = new k(c,a + "enter",w,t,v),
                    k.target = d,
                    k.relatedTarget = F,
                    h = k),
                    F = h,
            ...
            e: {
                ...
                g === "select" || g === "input" && p.type === "file")
                    ...
                    (g = p.nodeName) && g.toLowerCase() === "input" && (p.type === "checkbox" || p.type === "radio") && (E = Hc);
                if (E && (E = E(e, f))) {
                    fs(m, E, t, v);
                    break e
                }
            ...
            N && (ss && t.locale !== "ko" && (Rn || N !== "onCompositionStart" ? N === "onCompositionEnd" && Rn && (_ = os()) : (qe = v,
            ...
            _ ? N.data = _ : (_ = cs(t),
            _ !== null && (N.data = _)))),
            (_ = Rc ? Oc(e, t) : Fc(e, t)) && (f = Tr(f, "onBeforeInput"),
            0 < f.length && (v = new Ru("onBeforeInput","beforeinput",null,t,v),
            m.push({
                event: v,
                listeners: f
            }),
...
var ii = typeof setTimeout == "function" ? setTimeout : void 0
  ...
  , qc = typeof queueMicrotask == "function" ? queueMicrotask : typeof Yu < "u" ? function(e) {
    return Yu.resolve(null).then(e).catch(bc)
}
: ii;
function bc(e) {
    setTimeout(function() {
...
var rt = Math.random().toString(36).slice(2)
  ...
  , ui = "__reactEvents$" + rt
  , ef = "__reactListeners$" + rt
  , nf = "__reactHandles$" + rt;
function gn(e) {
    var n = e[Re];
    if (n)
        return n;
...
function xs(e, n, t) {
    ...
    for (var l in r)
        if (!(l in n))
            throw Error(y(108, Aa(e) || "Unknown", l));
    return A({}, t, r)
}
function Dr(e) {
...
function jr(e, n, t, r) {
    ...
    if (o !== null) {
        ...
        o = v.lastBaseUpdate,
        o !== u && (o === null ? v.firstBaseUpdate = f : o.next = f,
        v.lastBaseUpdate = s))
    }
    if (i !== null) {
        var m = l.baseState;
...
function Rs(e) {
    ...
    function o(c, a, d, h) {
        return a === null || a.tag !== 6 ? (a = Rl(d, c.mode, h),
        a.return = c,
        a) : (a = l(a, d),
        a.return = c,
        a)
    ...
    function s(c, a, d, h) {
        var E = d.type;
        return E === Dn ? v(c, a, d.props.children, h, d.key) : a !== null && (a.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Xe && ro(E) === a.type) ? (h = l(a, d.props),
        h.ref = ft(c, a, d),
        h.return = c,
        h) : (h = Sr(d.type, d.key, d.props, null, c.mode, h),
        h.ref = ft(c, a, d),
        h.return = c,
        h)
    }
    function f(c, a, d, h) {
        return a === null || a.tag !== 4 || a.stateNode.containerInfo !== d.containerInfo || a.stateNode.implementation !== d.implementation ? (a = Ol(d, c.mode, h),
        a.return = c,
        a) : (a = l(a, d.children || []),
        a.return = c,
        a)
    ...
    function v(c, a, d, h, E) {
        return a === null || a.tag !== 7 ? (a = En(d, c.mode, h, E),
        a.return = c,
        a) : (a = l(a, d),
        a.return = c,
        a)
    ...
    function m(c, a, d) {
        if (typeof a == "string" && a !== "" || typeof a == "number")
            return a = Rl("" + a, c.mode, d),
            a.return = c,
            a;
        if (typeof a == "object" && a !== null) {
            switch (a.$$typeof) {
            case Zt:
                return d = Sr(a.type, a.key, a.props, null, c.mode, d),
                d.ref = ft(c, null, a),
                d.return = c,
                d;
            case Mn:
                return a = Ol(a, c.mode, d),
                a.return = c,
                a;
            case Xe:
                var h = a._init;
    ...
    function p(c, a, d, h) {
        ...
        if (typeof d == "object" && d !== null) {
            ...
            case Xe:
                return E = d._init,
                p(c, a, E(d._payload), h)
            }
            if (vt(d) || ut(d))
                return E !== null ? null : v(c, a, d, h, null);
            or(c, d)
        }
        return null
    }
    function g(c, a, d, h, E) {
        ...
        if (typeof h == "object" && h !== null) {
            switch (h.$$typeof) {
            case Zt:
                return c = c.get(h.key === null ? d : h.key) || null,
                s(a, c, h, E);
            case Mn:
                return c = c.get(h.key === null ? d : h.key) || null,
                f(a, c, h, E);
                ...
                e: {
                    for (var E = d.key, x = a; x !== null; ) {
                        if (x.key === E) {
                            ...
                            } else if (x.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Xe && ro(E) === x.type) {
                                t(c, x.sibling),
                                a = l(x, d.props),
                                a.ref = ft(c, x, d),
                                a.return = c,
                    ...
                    d.type === Dn ? (a = En(d.props.children, c.mode, h, d.key),
                    a.return = c,
                    c = a) : (h = Sr(d.type, d.key, d.props, null, c.mode, h),
                    h.ref = ft(c, a, d),
                    h.return = c,
                    c = h)
                }
...
function nu(e, n, t, r, l, i) {
    ...
    n.updateQueue = null,
    n.lanes = 0,
    hr.current = e === null || e.memoizedState === null ? af : cf,
    e = t(r, l),
    Ct) {
        i = 0;
        do {
...
function fo(e, n, t, r, l) {
    ...
    n.stateNode === null)
        ...
        var s = u.context
          , f = t.contextType;
        typeof f == "object" && f !== null ? f = Se(f) : (f = ae(t) ? Cn : te.current,
        f = Zn(n, f));
        var v = t.getDerivedStateFromProps
          , m = typeof v == "function" || typeof u.getSnapshotBeforeUpdate == "function";
        m || typeof u.UNSAFE_componentWillReceiveProps != "function" && typeof u.componentWillReceiveProps != "function" || (o !== r || s !== f) && to(n, u, r, f),
        Ge = !1;
        ...
        s = n.memoizedState),
        (o = Ge || no(n, t, o, r, p, s, f)) ? (m || typeof u.UNSAFE_componentWillMount != "function" && typeof u.componentWillMount != "function" || (typeof u.componentWillMount == "function" && u.componentWillMount(),
        ...
        Ls(e, n),
        o = n.memoizedProps,
        f = n.type === n.elementType ? o : _e(n.type, o),
        u.props = f,
        m = n.pendingProps,
        p = u.context,
        s = t.contextType,
        ...
        w = n.memoizedState),
        (f = Ge || no(n, t, f, r, p, w, s) || !1) ? (v || typeof u.UNSAFE_componentWillUpdate != "function" && typeof u.componentWillUpdate != "function" || (typeof u.componentWillUpdate == "function" && u.componentWillUpdate(r, w, s),
        ...
        u.state = w,
        u.context = s,
        r = f) : (typeof u.componentDidUpdate != "function" || o === e.memoizedProps && p === e.memoizedState || (n.flags |= 4),
        typeof u.getSnapshotBeforeUpdate != "function" || o === e.memoizedProps && p === e.memoizedState || (n.flags |= 1024),
        r = !1)
    }
        ...
        for (f in l)
            if (!r.hasOwnProperty(f) && l.hasOwnProperty(f) && l[f] != null)
                if (f === "style") {
                    ...
                    f !== "dangerouslySetInnerHTML" && f !== "children" && f !== "suppressContentEditableWarning" && f !== "suppressHydrationWarning" && f !== "autoFocus" && (zt.hasOwnProperty(f) ? i || (i = []) : (i = i || []).push(f, null));
        for (f in r) {
            var s = r[f];
            if (o = l?.[f],
            r.hasOwnProperty(f) && s !== o && (s != null || o != null))
                if (f === "style")
                    ...
                    o = o ? o.__html : void 0,
                    s != null && o !== s && (i = i || []).push(f, s)) : f === "children" ? typeof s != "string" && typeof s != "number" || (i = i || []).push(f, "" + s) : f !== "suppressContentEditableWarning" && f !== "suppressHydrationWarning" && (zt.hasOwnProperty(f) ? (s != null && f === "onScroll" && R("scroll", e),
                ...
                e: {
                    ...
                    for (i in o)
                        if (o.hasOwnProperty(i)) {
                            ...
                            s != null && Ao(e, s)) : i === "children" ? typeof s == "string" ? (t !== "textarea" || s !== "") && Pt(e, s) : typeof s == "number" && Pt(e, "" + s) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (zt.hasOwnProperty(i) ? s != null && i === "onScroll" && R("scroll", e) : s != null && Ti(e, i, s, u))
                        }
                    switch (t) {
                    case "input":
                        Jt(e),
            ...
            s !== null)
                try {
                    ...
                    for (u = 0; u < s.length; u += 2) {
                        var v = s[u]
                          , m = s[u + 1];
                        v === "style" ? Ho(l, m) : v === "dangerouslySetInnerHTML" ? Ao(l, m) : v === "children" ? Pt(l, m) : Ti(l, v, m, f)
                    }
                    switch (o) {
                    case "input":
                        Hl(l, i);
...
function on(e) {
    return e.mode & 1 ? L & 2 && J !== 0 ? J & -J : rf.transition !== null ? (kr === 0 && (kr = bo()),
    kr) : (e = M,
    e !== 0 || (e = window.event,
...
function ce(e, n) {
    ...
    e.callbackPriority !== n) {
        if (t != null && Pu(t),
        n === 1)
            e.tag === 0 ? tf(So.bind(null, e)) : _s(So.bind(null, e)),
            qc(function() {
                !(L & 6) && pn()
            }),
            t = null;
            ...
            e: {
                ...
                do {
                    ...
                    case 1:
                        ...
                        var a = i.type
                          , d = i.stateNode;
                        if (!(i.flags & 128) && (typeof a.getDerivedStateFromError == "function" || d !== null && typeof d.componentDidCatch == "function" && (un === null || !un.has(d)))) {
                            i.flags |= 65536,
                            n &= -n,
                            i.lanes |= n;
                            var h = ta(i, o, n);
...
function fu() {
    (K === 0 || K === 3 || K === 2) && (K = 4),
    G === null || !(Nn & 268435455) && !(nl & 268435455) || Je(G, J)
}
function Qr(e, n) {
    var t = L;
    L |= 2;
...
var Ff = {
  ...
  , If = {
    ...
    findFiberByHostInstance: pt.findFiberByHostInstance || Rf,
...
const Hf = e => (n, t, {default: r, ...l}, {client: i}) => {
    ...
    for (const [f,v] of Object.entries(l))
        t[f] = Ue.createElement(yu, {
            value: v,
            name: f
        });
    const o = Ue.createElement(n, t, Af(r, e.hasAttribute("data-react-children")))
      , s = Uf(e);
    if (s && delete e[s],
    i === "only")
        return Ue.startTransition( () => {
            const f = La(e);
            f.render(o),
            e.addEventListener("astro:unmount", () => f.unmount(), {
                once: !0
            })
        }
        );
